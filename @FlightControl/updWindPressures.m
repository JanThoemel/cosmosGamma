...
this.WindPressureVector = this.getWindPressureVector( this.WindPressure, this.SurfacePanel, ...
	                                            this.Panels(1), this.Panels(2), ...
                                              this.Panels(3), this.Alphas, this.Betas,...
                                              this.Gammas, rho, v, tempAtmos);
