...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  methods % Constructor.
    ...
    function this = CosmosSimulation(maxNumOrbits, accelFactor, selectedModeID,...
      modeName, numSatellites, attitudeResolutionDeg, initOrbitAltitude,...
      sizeOrbitSection, initOrbitSection, rMatrixDiagonal, autoResponse,...
      availableGPS, availableTLE, initConditions, ffpsFolderName, ffpsValues)
