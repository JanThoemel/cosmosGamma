...
% Reference:
% https://www.mathworks.com/matlabcentral/fileexchange/24420-close-all-figures-except-those-listed
%  Close all figures except those listed
%  version 1.1.0.0 (1.46 KB) by Karl
%  Updated 22 Jun 2009

% Uncomment this to include ALL windows, including those with hidden handles (e.g. GUIs)
